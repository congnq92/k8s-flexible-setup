...
| #2 | Worker group        | Worker        | standard term          | `2-1` enables workload scheduling on a control-plane node;<br> `2-2` installs dedicated-worker prerequisites.<br>Runs Ingress and application Pods |
